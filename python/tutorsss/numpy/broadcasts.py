...
addingBothAxis = np.zeros(shape = (2, 4), dtype = np.int32) + newArr([[1, 2], 
                                                                      [3, 4]]) #! not working. can only be compatible in one way or perfectly?
print("Added in both axis, with compatible size:\n", addingBothAxis)
